...
//    public func setImageView(urls urlStrings: [String], placeholder image: UIImage? = nil, item: Int, controller: UIViewController? = nil) {
//        print("urls count is *******  \(urlStrings), **** item \(item)")
...
//        print(" urlStrings[item]  \( urlStrings[item])")
//    }
